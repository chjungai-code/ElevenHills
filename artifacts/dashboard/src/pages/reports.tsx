...
export default function ReportsPage() {
  ...
  return (
    <div style={{ maxWidth: 1100 }}>
      ...
      {/* TIER 1 */}
      <TierBar num={1} title="핵심 KPI" desc="이사회 보고·주주 보고서용 — 매 이사회 검토" />
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 10 }} className="kpi-grid-t1">
        <KpiCard stripe={C.accent} badgeType="port" badge="포트폴리오" name="포트폴리오 임대율" en="Portfolio Occupancy Rate" val="—%" delta="전분기 대비 개선" note="전체 임대가능면적(GLA) 중 임대된 비율. 리테일 임대사업의 최우선 지표." reit="REIT 공시 핵심 지표" />
        <KpiCard stripe={C.blue} badgeType="income" badge="임대수익" name="총 임대수익 (GRI)" en="Gross Rental Income" val="—억원" delta="전년 동기 대비" note="청구된 임대료 총액. 임대사업 손익의 최상단 매출 항목." reit="REIT 공시 핵심 지표" />
        <KpiCard stripe={C.blue} badgeType="income" badge="임대수익" name="순영업이익 (NOI)" en="Net Operating Income" val="—억원" delta="예산 대비 초과" note="GRI에서 운영비용 차감. 모든 부동산 투자자가 주시하는 핵심 수익성 지표." reit="REIT FFO 산출의 출발점" />
        <KpiCard stripe={C.purple} badgeType="fin" badge="재무건전성" name="사업운영수익 (FFO)" en="Funds From Operations" val="—억원" delta="전년 동기 대비" note="당기순이익에 감가상각비를 더하고 자산매각수익을 차감한 포트폴리오의 실질 현금창출능력." reit="REIT 배당 재원 핵심 지표" />
        <KpiCard stripe={C.accent} badgeType="port" badge="포트폴리오" name="가중평균 잔여 임대기간 (WALE)" en="Weighted Avg. Lease Expiry" val="— 년" delta="목표 3년 이상 유지" note="수익의 가시성 지표. WALE이 길수록 안정적인 미래 임대수익을 의미." reit="REIT 투자자 필수 확인 지표" />
        <KpiCard stripe={C.purple} badgeType="fin" badge="재무건전성" name="순자산가치 (NAV)" en="Net Asset Value" val="—억원" delta="가치평가 상승" note="보유 부동산의 시장가치 총액에서 총부채를 차감한 포트폴리오의 순투자가치." reit="REIT 주가 및 기업가치 평가 기준" />
        <KpiCard stripe={C.green} badgeType="traffic" badge="집객·임차인" name="임차인 평당 매출" en="Tenant Sales per sqm" val="—만원" delta="전년 동기 대비" note="임차인의 리테일 생산성. 임대 갱신 가능성과 임대료 인상 여력의 예측 지표." reit="리테일 REIT 핵심 모니터링 항목" />
        <KpiCard stripe={C.purple} badgeType="fin" badge="재무건전성" name="순부채 / EBITDA" en="Net Debt / EBITDA" val="— 배" delta="커버넌트 이내" note="레버리지 비율. 금융기관과 주주가 리스크 지표로 가장 먼저 확인하는 수치." reit="REIT 신용등급 핵심 기준" />
      </div>
